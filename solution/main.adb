...
S:G$game_Core_Loop$0_0$0({2}DF,SV:S),C,0,0
S:G$performat_Delay$0_0$0({2}DF,SV:S),C,0,0
S:G$text_Load_Font$0_0$0({2}DF,SV:S),C,0,0
S:G$text_Print_Char_Bkg_Or_Win$0_0$0({2}DF,SV:S),C,0,0
S:G$text_Print_String_Bkg_Or_Win$0_0$0({2}DF,SV:S),C,0,0
S:G$initialize_Game$0_0$0({2}DF,SV:S),C,0,0
S:G$initialize_HUD$0_0$0({2}DF,SV:S),C,0,0
