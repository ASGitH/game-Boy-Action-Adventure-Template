M:main
S:Lmain.move_bkg$x$1_0$50({1}SC:U),B,1,2
S:Lmain.move_bkg$y$1_0$50({1}SC:U),B,1,3
S:Lmain.scroll_bkg$x$1_0$52({1}SC:S),B,1,2
S:Lmain.scroll_bkg$y$1_0$52({1}SC:S),B,1,3
S:Lmain.move_win$x$1_0$62({1}SC:U),B,1,2
S:Lmain.move_win$y$1_0$62({1}SC:U),B,1,3
S:Lmain.scroll_win$x$1_0$64({1}SC:S),B,1,2
S:Lmain.scroll_win$y$1_0$64({1}SC:S),B,1,3
S:Lmain.SET_SHADOW_OAM_ADDRESS$address$1_0$69({2}DG,SV:S),B,1,2
S:Lmain.set_sprite_tile$nb$1_0$71({1}SC:U),B,1,2
S:Lmain.set_sprite_tile$tile$1_0$71({1}SC:U),B,1,3
S:Lmain.get_sprite_tile$nb$1_0$73({1}SC:U),B,1,2
S:Lmain.set_sprite_prop$nb$1_0$75({1}SC:U),B,1,2
S:Lmain.set_sprite_prop$prop$1_0$75({1}SC:U),B,1,3
S:Lmain.get_sprite_prop$nb$1_0$77({1}SC:U),B,1,2
S:Lmain.move_sprite$nb$1_0$79({1}SC:U),B,1,2
S:Lmain.move_sprite$x$1_0$79({1}SC:U),B,1,3
S:Lmain.move_sprite$y$1_0$79({1}SC:U),B,1,4
S:Lmain.move_sprite$itm$1_0$80({2}DG,STOAM_item_t:S),B,1,-2
S:Lmain.scroll_sprite$nb$1_0$81({1}SC:U),B,1,2
S:Lmain.scroll_sprite$x$1_0$81({1}SC:S),B,1,3
S:Lmain.scroll_sprite$y$1_0$81({1}SC:S),B,1,4
S:Lmain.scroll_sprite$itm$1_0$82({2}DG,STOAM_item_t:S),B,1,-2
S:Lmain.hide_sprite$nb$1_0$83({1}SC:U),B,1,2
...
S:G$playerS$0_0$0({0}STplayer:S),E,0,0
